...
import me.dalot.classes.ChatInputs;
import me.dalot.classes.Delay;
    ...
    public void onClick(InventoryClick e) {
        switch (e.slot()) {
            ...
            case 49 -> {
                ...
                ProxyAnnouncer.getInstance().getServer().getScheduler().buildTask(ProxyAnnouncer.getInstance(), this::open).delay(3, TimeUnit.SECONDS).schedule();
            }
            case 53 -> {
                //return
